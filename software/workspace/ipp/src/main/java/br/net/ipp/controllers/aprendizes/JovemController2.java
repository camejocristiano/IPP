...
public class JovemController2 {
	...
	public ModelAndView jovem(Jovem jovem) {
		...
		List<String> aEDiasDaSemana = this.carregarAEDiasDaSemana();
		modelAndView.addObject("aEDiasDaSemana", aEDiasDaSemana);
		List<String> diasDaSemana = this.carregarDiasDaSemana();
		modelAndView.addObject("diasDaSemana", diasDaSemana);
		List<String> tiposDeCNH = this.carregarTiposDeCNH();
		modelAndView.addObject("tiposDeCNH", tiposDeCNH);
		List<String> servicoMilitarSituacoes = this.carregarServicoMilitarSituacoes();
