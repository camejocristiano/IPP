	...
	<div class="row">
		...
		<div class="col s12 m6 l4">
			<div class="card blue-grey darken-1">
				...
				<a href="/sw/usuarios/form" class="btn-index">
		...
		<div class="col s12 m6 l4">
			<div class="card blue-grey darken-1">
				...
				<a href="/sw/gruposDePermissoes/form" class="btn-index">
		...
		<div class="col s12 m6 l4">
			<div class="card blue-grey darken-1">
				...
				<a href="/sw/unidades/form" class="btn-index">
					<div class="card-action">
						<h6 style="color: #eee !important;">Novo</h6>
					</div>
				</a>
	...
	<div class="row">
		...
		<div class="col s12 m6 l4">
			<div class="card blue-grey darken-1">
				...
				<a href="/sw/canais/form" class="btn-index">
			    	<div class="card-action">
			    		<h6 style="color: #eee !important;">Novo</h6>
			    	</div>
				</a>
	    ...
	    <div class="col s12 m6 l4">
	    	<div class="card blue-grey darken-1">
				...
				<a href="/sw/arquivos/form" class="btn-index">
		            <div class="card-action">
		              <h6 style="color: #eee !important;">Novo</h6>
		            </div>
				</a>
	    ...
	    <div class="col s12 m6 l4">
	    	<div class="card blue-grey darken-1">
				...
				<a href="/sw/agendamentos/form" class="btn-index">
		            <div class="card-action">
		              <h6 style="color: #eee !important;">Novo</h6>
		            </div>
				</a>
