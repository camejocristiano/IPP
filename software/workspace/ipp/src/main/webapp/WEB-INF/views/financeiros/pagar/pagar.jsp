...
<div class="container" id="main-container-content">
	<div class="row">
		...
		<c:url value="/sw/conta/${contaAPagar.razaoSocial != null ? contaAPagar.id : null}" var="swContaAPagarId"></c:url>
      	<form:form role="form" commandName="contaAPagar" servletRelativeAction="${swContaAPagarId}" method="POST">
   			<div class="row">
