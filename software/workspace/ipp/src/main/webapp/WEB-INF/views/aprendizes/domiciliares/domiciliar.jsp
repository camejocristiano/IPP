...
<div class="container" id="main-container-content">
	<div class="row">
		<div class="input-field s12 col l12" style="border-top: 2px solid orange;">
			 <h4 class="header right orange-text">Características Domiciliares: <a class="header right" href="/jovens/${caracteristicasDomiciliares.jovem != null ? caracteristicasDomiciliares.jovem.id : jovem.id}">${caracteristicasDomiciliares.jovem != null ? caracteristicasDomiciliares.jovem.nome : jovem.nome}</a></h4>
		</div>
	</div>
	<div class="row">
		<form:form role="form" commandName="caracteristicasDomiciliares" servletRelativeAction="/caracteristicasDomiciliares/${caracteristicasDomiciliares.jovem != null ? caracteristicasDomiciliares.id : null}" method="POST">
		<div class="s12 col l12">	
			<div class="row">
				<div class="s12 col l12">
					${caracteristicasDomiciliares.jovem != null ? caracteristicasDomiciliares.jovem.nome : jovem.nome}
					<hr />
					<hr />
				</div><!-- // col -->
			</div><!-- // row -->
