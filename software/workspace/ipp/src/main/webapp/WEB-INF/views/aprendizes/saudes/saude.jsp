...
<div class="container" id="main-container-content">
	<div class="row">
		<div class="input-field  s12 col l12" style="border-top: 2px solid orange;">
			 <h4 class="header right orange-text">Situação de Saúde: <a class="header right" href="/jovens/${situacaoDeSaude.jovem != null ? situacaoDeSaude.jovem.id : jovem.id}">${situacaoDeSaude.jovem != null ? situacaoDeSaude.jovem.nome : jovem.nome}</a></h4>
		</div>
	</div>
	<div class="row">
		<form:form role="form" commandName="situacaoDeSaude" servletRelativeAction="/situacoesDeSaude/${situacaoDeSaude.id}" method="POST">
		<div class="s12 col l12">	
			<div class="row">
				<div class="input-field s12 col l12">
					${situacaoDeSaude.jovem != null ? situacaoDeSaude.jovem.nome : jovem.nome}
					<hr />
					<hr />
					<div class="row">
