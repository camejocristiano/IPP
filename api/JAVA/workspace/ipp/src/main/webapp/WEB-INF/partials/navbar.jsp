...
<nav class="white" role="navigation">
    <div class="nav-wrapper container"><a id="logo-container" href="/" class="brand-logo"><img width="133em" style="margin-top: .2em;" id="logo" src="../../assets/images/ipp-logo.png"></a>
      <ul class="right hide-on-med-and-down">
        ...
        <li><a href="/" style="color: #222 !important;">Empresas</a></li>
        <li><a href="/" style="color: #222 !important;">Financeiro</a></li>
        <li><a href="/login"><i class="material-icons" style="color: #222 !important;">exit_to_app</i></a></li>
      </ul>
