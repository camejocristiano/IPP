...
class EMServiceTest extends UnitTestCase
{
    ...
    public function testInsertANewUser()
    {
        ...
        $this->assertInstanceOf("src\\Entity\\User", $insert);
    }

    /**
     * @expectedException InvalidArgumentException
     * @expectedExceptionMessage Parameter invalid must be a src\Entity\Contract\Entity instance
     */
    ...
    public function testUpdateANewUser()
    {
        ...
        $user = $this->er->getRepository('src\Entity\User')->find(1);
        ...
        $this->assertInstanceOf("src\Entity\User", $update);
    }
